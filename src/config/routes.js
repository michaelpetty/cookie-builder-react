...
const Routes = ({ isLoggedIn, openLogin, user, faves, toggleFave, setHeader }) => (
  <Switch>
    ...
    <Route path='/order-form/:recipeId' render={(props) => <OrderForm {...props} isLoggedIn={isLoggedIn} openLogin={openLogin} user={user} toggleFave={toggleFave} setHeader={setHeader} />} />
